...
def main():
    args = opts().parse([
        ...
        '--num_local_epochs', '3', '--resize', '--input_c', '1', '--image_size', '28',
        '--model', 'cnn_mnist', '--dataset', 'mnist', '--trainer', 'async_trainer', '--lr',
        '0.001', '--optim', 'sgd', '--momentum', '0.9', '--num_clients', '100', '--num_rounds',
        '400', '--selector', 'random_async', '--select_ratio', '0.01', '--sampler', 'non-iid',
        '--sampler_num_classes', '2', '--sampler_num_samples', '300', '--fedasync_rho', '0.005',
