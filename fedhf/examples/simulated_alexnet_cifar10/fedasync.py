...
def main():
    args = opts().parse([
        ...
        '--num_local_epochs', '5', '--resize', '--input_c', '3',
        '--image_size', '24', '--model', 'cnn_cifar10', '--dataset', 'cifar10',
        '--trainer', 'async_trainer', '--lr', '0.1', '--optim', 'sgd',
        '--num_clients', '100', '--num_rounds', '2000', '--selector',
        'random_async', '--select_ratio', '0.01', '--sampler', 'non-iid',
        '--fedasync_rho', '0.005', '--fedasync_strategy', 'hinge',
        '--fedasync_alpha', '0.9', '--fedasync_max_staleness', '4',
