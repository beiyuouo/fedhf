...
def main():
    args = opts().parse([
        ...
        '--dataset', 'cifar10', '--trainer', 'async_trainer', '--lr', '0.1', '--optim', 'sgd',
        '--num_clients', '100', '--num_rounds', '400', '--selector', 'random_async',
        '--select_ratio', '0.01', '--sampler', 'non-iid', '--fedasync_rho', '0.005',
        '--fedasync_strategy', 'constant', '--fedasync_alpha', '0.9',
        '--fedasync_max_staleness', '4', '--fedasync_a', '10', '--fedasync_b', '4'
    ])
