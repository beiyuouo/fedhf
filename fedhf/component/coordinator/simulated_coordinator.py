...
from fedhf.component.client.simulated_client import SimulatedClient
from fedhf.component.logger.logger import Logger
from fedhf.component.sampler import build_sampler
from fedhf.component.selector import build_selector
from fedhf.component.server.simulated_server import SimulatedServer
...
class SimulatedCoordinator(BaseCoordinator):
    ...
    def prepare(self) -> None:
        ...
        self.server = SimulatedServer(self.args)
        self.client = SimulatedClient(self.args)
    ...
    def main(self) -> None:
        for i in range(self.args.num_rounds):
            ...
            for client in selected_client:
                ...
                model = self.client.train(self.data[client], model)
