...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            "--wandb_log_client", action="store_true", help="log train on client or not"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--image_size", type=int, default=224, help="image_size"
        )
        self.parser.add_argument(
            "--output_c", type=int, default=1, help="output channel"
        )
        self.parser.add_argument(
